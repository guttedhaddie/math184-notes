...
\paragraph{Terminology and Trigonometric Tables}
...
\paragraph{Calculating the \emph{Qibla}}
...
\begin{proof}
	...
	\begin{minipage}[t]{0.55\linewidth}\vspace{-5pt}
		Consider the right-angled \textcolor{mRed}{planar triangle $CKL$.} Since $\alpha$ is the angle between two planes, we have $\textcolor{red}{\alpha=\measuredangle CLK}$. Moreover
		\begin{gather*}
