...
\begin{enumerate}\setcounter{enumi}{1}
  \item This time we solve $x^3+3x=14$.
	...
	\end{align*}
	As this shows, Cardano's formula might produce an ugly expression for a simple answer---of course, the cube root of $5\sqrt 2\pm 7$ is the tip of everyone's tongue!
...
\begin{description}\phantomsection\label{pg:factorthm}
	...
	\item[Factor Theorem] In 1637, Descartes proved that $p(r)=0\Longleftrightarrow p(x)$ is divisible by $x-r$, essentially via long-division.\par
