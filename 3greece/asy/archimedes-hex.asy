...
fill(O--A--B--cycle,SkyBlue+White);
fill(A--B--C--cycle,Lime+White);
...
draw(Label("$d_{n+1}$",align=dir(th/4+90),Relative(0.75)),O--P,Green+linewidth(1));
draw(B--Q--C,linewidth(1));
draw(Label("$h_{n+1}$",align=1.5dir(th/4),Relative(0.5)),A--P,Magenta+linewidth(1));
