...
\begin{description}\itemsep2pt
	\begin{minipage}[t]{0.62\linewidth}\vspace{-10pt}
	  \item[Documented civilization] Dates from c.\,3000\BC. Until around \AD 200, China refers roughly to the area in the map: north of the Yangtze and around the Yellow river. A more detailed timeline map can be found \href{https://timemaps.com/history/china-200bc/}{here.}\vspace{2pt}
