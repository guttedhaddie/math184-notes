...
label("Orbits of \textcolor{blue}{Earth}, \textcolor{red}{Mars} and \textcolor{Green}{Jupiter} and the \textcolor{orange}{fixed stars}",(0,-11));
label("Retrograde motion when planets get `close' and Earth overtakes",(0,-12));
A.add();
restore();
}
...
//A.movie(BBox(0.25cm),loops=1,delay=250);
