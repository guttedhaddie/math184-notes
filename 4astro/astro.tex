...
\boldsubsubsection{Hipparchus of Nicaea/Rhodes (c.\,190--120\BC)} \phantomsection\label{ssec:hipparchus}
...
Born in Egypt and living much of his life in Alexandria, Claudius Ptolemy (c.\,\AD 100--170) was a Greek/Egyptian/Roman\footnote{%
	Ptolemy (Ptolemaeus) is a Greek name, while Claudius is Roman, reflecting the changing cultural situation in Egypt.%
} astronomer and mathematician. Around \AD 150, he produced the \emph{Mathematica Syntaxis,} better known as the \emph{Almagest}. The latter term is derived from the Arabic \emph{al-mageisti} (great work), reflecting its importance to later Islamic learning.\smallbreak
 
The \emph{Almagest} is essentially a textbook on geocentric cosmology. It shows how to compute the motions of the moon, sun and planets, describing lunar parallax, eclipses, the constellations, and elementary spherical trigonometry (this last probably courtesy of Menelaus c.\,\AD 100). It contains our best evidence as to the accomplishments of Hipparchus and describes his calculations. The \emph{Almagest} formed the basis of Western/Islamic astronomical theory well into the 1600s.
...
\boldinline{How did Ptolemy know exact values for $\crd \ang{36}$ and $\crd \ang{72}$?}
...
\boldinline{Angle-addition \& the Multiple-angle Formula}
