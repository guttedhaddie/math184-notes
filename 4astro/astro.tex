...
\begin{description}
	...
	\]
	To obtain these arc-minute approximations, it is believed Ptolemy computed half-angle chords to an accuracy of \emph{five sexagesimal places} (1 part in over 750 million!).  The construction of the chord-table was truly a gargantuan task, one for which Ptolemy almost certainly had assistance.
\end{description} 
