...
\begin{exercises}{}{}
	\hangindent\leftmargini\emph{Key concepts: \ Basic algebra encodes geometric facts, \ Analytic geometry helped algebra \& number eclipse geometry, \ Fermat \& Descartes' single-axis approach}
...
\begin{minipage}[t]{0.4\linewidth}\vspace{-3pt}
	\hfill\includegraphics{analytic-oresme}
\end{minipage}\par
\begin{gather*}
...
\begin{minipage}[t]{0.35\linewidth}\vspace{0pt}
	\hfill\includegraphics{analytic-adequation}
\end{minipage}
\medbreak
...
\begin{center}
	\includegraphics[]{analytic-desnormal}
\end{center}
...
\begin{minipage}[t]{0.4\linewidth}\vspace{0pt}
	\hfill\includegraphics{analytic-fermat-area}
\end{minipage}
\medbreak
